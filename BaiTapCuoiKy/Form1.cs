...
namespace BaiTapCuoiKy
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeGame()
        {
            ...
            toolStripStatusLabel.Text = "Nh?p tên và t?o phòng ho?c tham gia game";
            lblGameStatus.Text = "Ch? ng??i ch?i tham gia...";
            
            // Initialize sample players for demo
            AddPlayer("Player1");
            AddChatMessage("System", "Chào m?ng ??n v?i Drawing Guess Game!");
        }
        ...
        private void btnClearCanvas_Click(object sender, EventArgs e)
        {
            if (isGameActive && isPlayerDrawing)
            {
                drawingGraphics.Clear(Color.White);
                panelDrawing.Invalidate();
                AddChatMessage("System", $"{playerName} ?ã xóa b?ng v?");
            }
        }
        ...
        private void SendChatMessage()
        {
            ...
            if (!string.IsNullOrEmpty(message) && !string.IsNullOrEmpty(playerName))
            {
                ...
                {
                    // Correct guess!
                    AddChatMessage("System", $"?? {playerName} ?ã ?oán ?úng: {currentWord}!");
        ...
        private void btnCreateRoom_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nh?p tên ng??i ch?i!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            toolStripStatusLabel.Text = $"Phòng {roomCode} ?ã ???c t?o";
            lblGameStatus.Text = "Ch? ng??i ch?i khác tham gia...";
            AddChatMessage("System", $"Phòng {roomCode} ?ã ???c t?o b?i {playerName}");
        }
        ...
        private void btnJoinGame_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nh?p mã phòng!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            toolStripStatusLabel.Text = $"?ã tham gia phòng {roomCode}";
            lblGameStatus.Text = "Ch? host b?t ??u game...";
            AddChatMessage("System", $"{playerName} ?ã tham gia phòng");
        }
        ...
        private void StartNewGame()
        {
            ...
            AddChatMessage("System", "?? Game b?t ??u! Chúc các b?n ch?i vui v?!");
        }
        ...
        private void StartNewRound()
        {
            ...
            lblGameStatus.Text = isPlayerDrawing ? "L??t c?a b?n - Hãy v?!" : "Hãy ?oán t? khóa!";
            AddChatMessage("System", $"Round {currentRound}: {(isPlayerDrawing ? "B?n ?ang v?" : "Hãy ?oán t? khóa!")}");
        }
        ...
        private void EndGame()
        {
            ...
            lblGameStatus.Text = "Game k?t thúc!";
            toolStripStatusLabel.Text = "Game ?ã k?t thúc";
            
            string finalMessage = $"?? Game k?t thúc!\n?i?m s? cu?i cùng: {playerScore}\nC?m ?n b?n ?ã ch?i!";
            AddChatMessage("System", finalMessage);
            
            MessageBox.Show(finalMessage, "Game K?t Thúc", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void LeaveGame()
        {
            ...
            toolStripStatusLabel.Text = "?ã r?i kh?i game";
            lblGameStatus.Text = "Ch? tham gia game m?i...";
            AddChatMessage("System", $"{playerName} ?ã r?i kh?i phòng");
        ...
        private void timerGame_Tick(object sender, EventArgs e)
        {
            if (isGameActive)
            {
                ...
                {
                    // Time's up!
                    AddChatMessage("System", $"? H?t gi?! T? c?n ?oán là: {currentWord}");
                    NextRound();
                }
            }
        }
